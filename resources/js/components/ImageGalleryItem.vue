<template>
    <div class="mb-8 px-2 w-1/2 grid-item">
        <input class="absolute h-0 w-0" ref="clipboardInput" type="text" :value="`${domain}/images/${image.slug}`" readonly>
        <a :href="`${domain}/images/${image.slug}`" class="block rounded">
            ...
            <p class="pt-3 mb-0 text-base leading-normal font-futura text-black">
                {{ image.name }}
            </p>
        </a>
    </div>
